...
/// <summary>
/// SQL Server <c>NEXT VALUE FOR</c> based sequence allocator.
/// </summary>
public sealed class SqlServerSequenceAllocator(ApplicationDbContext dbContext) : ISequenceValueAllocator
{
