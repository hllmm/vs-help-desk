...
expect_rejected "$FIXTURE_DIR/unsafe-generated-mail-policy-world.yaml" "unrestricted ipBlock CIDR 0.0.0.0/0 is forbidden"
...
expect_rejected "$FIXTURE_DIR/unsafe-generated-mail-policy-wrong-name.yaml" "SMTP/IMAP egress with an ipBlock is forbidden"
expect_rejected "$FIXTURE_DIR/unsafe-generated-mail-policy-wrong-marker.yaml" "SMTP/IMAP egress with an ipBlock is forbidden"
